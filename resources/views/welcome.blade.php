...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Fichaje en línea | Bienvenido</title>
    ...
    <body class="antialiased">
        ...
        <header id="header" class="fixed-top">
            ...
            <h1 class="logo me-auto"><a href="index.html">Fichaje en linea</a></h1>
            ...
            <a href="#appointment" class="appointment-btn scrollto"><span class="d-none d-md-inline">Solicitar una</span> Cita</a>
        ...
        <section id="hero" class="d-flex align-items-center">
            <div class="container">
            <h1>Bienvenido</h1>
            <h2>Servicio de fichaje y consulta médica en línea</h2>
        ...
        <main id="main">
            ...
            <div class="container">
                ...
                <form action="forms/appointment.php" method="post" role="form" class="php-email-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 form-group mt-3">
                            <select class="form-select" required>
                                ...
                                @foreach (App\Models\Especialidad::get() as $item)
                        ...
                        <div class="col-md-3 form-group mt-3">
                            <select name="turno_id" class="form-select" required>
                                ...
                                @foreach (App\Models\Turno::get() as $item)
                                <option value="{{ $item->id }}">{{ $item->nombre }}</option>
                                @endforeach
                            </select>
                            <div class="validate"></div>
                    ...
                    <div class="text-center"><button type="submit">Solicitar consulta</button></div>
                </form>
            ...
            <div class="container">
                ...
                <div class="col-lg-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active show" data-bs-toggle="tab" href="#tab-1">Medicina gral.</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#tab-2">Pediatría</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#tab-3">Cardiología</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#tab-4">Octalmología</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#tab-5">Fisioterapia</a>
                    </li>
                    </ul>
                </div>
                <div class="col-lg-9">
